...
if (version_compare(PHP_VERSION, '5.3') == -1) {
    require_once('../includes/class/xajax.php4.inc.php');
} else {
    require_once('../includes/class/xajax.php5.inc.php');
}

# load all needed func
require_once('../includes/func/db.php');
require_once('../includes/func/escape.php');
require_once('../includes/func/debug.php');


# load language
require_once ('../includes/lang/de.php');
